          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <div className="row">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text width-100px" id="inputGroup-sizing-default">Hp</span>
                  </div>
                    ...
                    this.state.listMahasiswa.map(mhs => {
                      return (
                        <tr>
                          ...
                          <td>{mhs.status}</td>
                          <td>
                            <button className="btn btn-danger" onClick={() => this.deteleData(mhs.id)} >Hapus</button>
                          </td>
                        </tr>
                      )
                    })
